package com.agileboot.admin.modular.sys.system.user;

import cn.hutool.core.convert.Convert;
import com.agileboot.admin.modular.sys.common.cache.CacheCenter;
import com.agileboot.admin.modular.sys.common.command.BulkOperationCommand;
import com.agileboot.admin.modular.sys.common.dto.CurrentLoginUserDTO;
import com.agileboot.admin.modular.sys.system.post.db.SysPostEntity;
import com.agileboot.admin.modular.sys.system.post.db.SysPostService;
import com.agileboot.admin.modular.sys.system.post.dto.PostDTO;
import com.agileboot.admin.modular.sys.system.role.db.SysRoleEntity;
import com.agileboot.admin.modular.sys.system.role.db.SysRoleService;
import com.agileboot.admin.modular.sys.system.role.dto.RoleDTO;
import com.agileboot.admin.modular.sys.system.user.command.AddUserCommand;
import com.agileboot.admin.modular.sys.system.user.command.ChangeStatusCommand;
import com.agileboot.admin.modular.sys.system.user.command.ResetPasswordCommand;
import com.agileboot.admin.modular.sys.system.user.command.UpdateProfileCommand;
import com.agileboot.admin.modular.sys.system.user.command.UpdateUserAvatarCommand;
import com.agileboot.admin.modular.sys.system.user.command.UpdateUserCommand;
import com.agileboot.admin.modular.sys.system.user.command.UpdateUserPasswordCommand;
import com.agileboot.admin.modular.sys.system.user.db.SearchUserDO;
...
import com.agileboot.admin.modular.sys.system.user.dto.UserDetailDTO;
import com.agileboot.admin.modular.sys.system.user.dto.UserProfileDTO;
import com.agileboot.admin.modular.sys.system.user.model.UserModel;
import com.agileboot.admin.modular.sys.system.user.model.UserModelFactory;
import com.agileboot.admin.modular.sys.system.user.query.SearchUserQuery;
