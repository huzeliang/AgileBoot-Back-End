package com.agileboot.admin.modular.sys.system.role.db;
...
import com.agileboot.admin.modular.sys.system.user.db.SysUserMapper;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRoleEntity> implements
    SysRoleService {
